# 📚 Referencias y Fuentes del Scriptorium

Este documento reúne todas las **fuentes de información**, **materiales de estudio** y **recursos externos** utilizados para construir cada capítulo del Scriptorium.  
La organización sigue la misma estructura del índice principal para facilitar la navegación.
